...
### ✨ Features - As per Task 2 Requirements
- **Market Data Display**: View live prices for TCS, INFY, RELIANCE, WIPRO
- **Buy/Sell Operations**: Purchase or sell stocks with balance validation
- **Portfolio Tracking**: Monitor cash balance, holdings, and total portfolio value
