...
// This is my CodeAlpha Task 1 - Stock Trading Platform
// I made it simple but tried to cover all the basic logic
// Date: Oct 2025

class Stock {
    String ticker;      // like INFY, TCS
    double currentPrice; 
    int sharesAvailable; // how many shares are left in market

    // Constructor to set up a stock
...
class User {
    double cashBalance; // money I have
    HashMap<String, Integer> myPortfolio = new HashMap<>(); // to track what I bought

    User(double startingCash) {
        this.cashBalance = startingCash; // starting with 100000
    }
    ...
    void sellShares(Stock stock, int quantity) {
        ...
        // Check if I actually own that many shares
    ...
    void showPortfolio() {
        ...
        // Loop through portfolio and print only if quantity > 0
...
public class StockTrading {
    public static void main(String[] args) {
        ...
        // Creating 2 stocks for our simple market
        Stock infy = new Stock("INFY", 1500.0, 100);
        Stock tcs = new Stock("TCS", 3500.0, 50);
        
        // Create user with 100k starting money
        ...
        while (running) {
            ...
            if (choice == 1) {
                ...
                running = false; // this will exit the loop
            } 
            else {
        ...
        input.close(); // closing scanner, good practice
    }
}